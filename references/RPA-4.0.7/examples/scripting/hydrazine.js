...
printf("------------------------------------------\n");
printf("Estimates the temperature of hydrazine decomposition at given decomposition rates x\n");
printf("H_N2H4L=%8.2f kJ/kg\n", H_N2H4L);
printf("------------------------------------------\n");
printf("x     T [K]    H [kJ/kg] R [J/(kg K)] k\n");
printf("------------------------------------------\n");
...
for (i=0; i<x.length; ++i) {
	...
	printf("%4.2f %8.2f %8.2f %8.2f       %4.2f\n", x[i], T, H, R, k);
}
